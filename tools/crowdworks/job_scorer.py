...
【評価基準】
1. 自動化適性 (0-25点): AI・RPA・スクレイピング・データ処理など自動化で効率化できる案件か
2. 報酬妥当性 (0-25点): 作業量に対して報酬が妥当か（時給換算2,000円以上が目安）
3. 明確性 (0-25点): 要件・成果物が明確に定義されているか
4. リスク (0-25点): トラブルリスクが低いか（曖昧な要件・過剰な期待・短すぎる納期は減点）
